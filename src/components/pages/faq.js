            ...
            items={[
              {
                ...
                text: (
                  <p>
                    ...
                    contribute financially, you can donate clothes, participate
                    in events and so on.
                  </p>
                ),
              },
              {
                ...
                text: (
                  <p>
                    Not quite. The event is organized by our foundation, but it
                    is possible to negotiate and co-organize the event.
                  </p>
                ),
              },
              {
          ...
          <Accordion
            items={[
              ...
              },
              {
                ...
                text: (
                  <p>
                    Yes. Paying money with PayPal is possible. After sending the
                    money, please contact us by e-mail and provide your name,
                    email and amount.
                  </p>
                ),
              },
          ...
          <Accordion
            items={[
              ...
              },
              {
                ...
                text: (
                  <p>
                    Unfortunately, no. Events are organized only in our country.
                    The only way to participate is to come to us.
                  </p>
                ),
              },
              {
                ...
                text: (
                  <p>
                    ...
                    friends, colleagues, family and other people. You can share
                    our posts on facebook, twitter and let us know about
